...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>ADMS, General User Home</title>
        ...
        <div id="tooplate_body_wrapper">
            <div id="tooplate_wrapper">
                ...
                <div id="tooplate_middle">
                    <div id="slider">
                        <a href="../../Help Manual/HTML Format/Welcome.html" Target="_blank"><img src="../../images/banner_01.jpg" alt="HELP" title="Click on the images for ADMS HELP" /></a>
                        <a href="../../Help Manual/HTML Format/Welcome.html" Target="_blank"><img src="../../images/banner_02.jpg" alt="HELP" title="Click on the images for ADMS HELP" /></a>
                        <a href="../../Help Manual/HTML Format/Welcome.html" Target="_blank"><img src="../../images/banner_03.jpg" alt="HELP" title="Click on the images for ADMS HELP" /></a>
                        <a href="../../Help Manual/HTML Format/Welcome.html" Target="_blank"><img src="../../images/banner_04.jpg" alt="HELP" title="Click on the images for ADMS HELP" /></a>
                ...
                <div id="tooplate_main">
                    <div class="col_allw300">
                        <h3>
                            ...
                            <br/></h3></div>  <div class="cleaner"></div>


                    <!-- end of main -->
                    <div class="cleaner"></div>
                    <h2><?php ?> Welcome to Agro Disease Management System!
                    </h2>
                    <p>
                        <em>You are logged in as General User.</em>
                    </p>
