            ...
            <div id="tooplate_wrapper">
                ...
                <div id="tooplate_header">
                    ...
                    <div id="tooplate_menu">
                        <ul>
                            <li><a href="GUserHome.php">Home</a></li>
                    ...
                    <br>
                        ...
                        <div id="registration-form">
                            <div class='fieldset'>
                                ...
                                <form data-validate="parsley" name="user" method="post" onSubmit="return testform()">
                                    <div class='row'>
                                        <label for='firstname'>User Name</label>
                                        <span class="style3">
                                            <input type="text" name='username' id='firstname'  required="required" value="<?php echo $un; ?>"/>
                                        </span></div>
                                    <div class='row'>
                                        <label for="password">Password</label>
                                        <input type="password"  name='password' value="<?php echo $pw; ?>" required="required" class="input"/>
                                    </div>
                                    <div class='row'>
