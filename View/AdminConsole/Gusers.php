    ...
    <body> 
                        ...
                        <ul class="current"><li><a href="#"><b>Users</b><!--[if IE 7]><!--></a><!--<![endif]-->
                                <div class="select_sub show">
                                    <ul class="sub">
                                        ...
                                        <li><a href="Susers.php">S-Users</a></li>
                                        <li  class="sub_show"><a href="#nogo">G-Users</a></li>
                                    </ul>
                                </div>
                            </li>
                        </ul>
        ...
        <div id="content-outer">
            ...
            <div id="content">
                ...
                <!--  start page-heading -->
                <div id="page-heading">
                    <h1>Registered General  Users</h1>
                </div>
                <!-- end page-heading -->
                                ...
                                <div id="content-table-inner">
                                    ...
                                    <div id="actions-box">
                                        ...
                                        <div id="actions-box-slider">
                                            ...
                                            <input class="action-delete" type="submit" name="ignore_guser" value="ignore"></input>
