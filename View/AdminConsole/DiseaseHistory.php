                    ...
                    <div class="table">
                        ...
                        <ul class="current"><li><a href="#"><b>Disease Details</b><!--[if IE 7]><!--></a><!--<![endif]-->
                                <div class="select_sub show">
                                    <ul class="sub">
                                        <li><a href="DiseaseDetails.php">Forum Requests</a></li> 
                                        <li class="sub_show"><a href="#">Disease-History</a></li>         
                                    </ul>
                                </div>
                            </li>
                        </ul>
                                        ...
                                        <form id="mainform">
                                            <table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
                                                ...
                                                <tbody>
                                                    ...
                                                    $query = "SELECT * FROM plant_desease_detail WHERE type='confirm'ORDER BY desease_ID DESC";
