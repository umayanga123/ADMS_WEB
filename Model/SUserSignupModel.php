...
if(!empty($_POST)){
    ...
    if ($_POST["password"] != $_POST["cpassword"]) {
        ...
        $suserSignupModel = new SUserSignupModel($_POST["username"],$_POST["password"], $_POST["cpassword"],
                                                $_POST["fullname"],$_POST["depname"], $_POST["depid"],
                                                $_POST["contactno"],$_POST["email"], $_POST["address"]);
